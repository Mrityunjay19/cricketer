...
par(mfrow=c(1,3))
par(mar=c(4,4,2,2))
bowlerContributionWonLost(30176,"Kumble")
bowlerContributionWonLost(8166,"Warne")
bowlerContributionWonLost(49636,"Murali")
dev.off()
```
...
2. Ponting takes the 2nd spot with the 3rd highest number of centuries, 1st in Strike Rate and 2nd in home and away performance.
3. The 3rd spot goes to Sangakkara, with the highest average, reasonable run frequency percentage in different run ranges. However he has a fewer number of matches overseas and his performance overseas is significantly lower than at home
